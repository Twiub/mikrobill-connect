...
const ALL_NAV_ITEMS = [
  ...
  { path: "/coverage-map",   icon: Map,             label: "Coverage Map" },
  { path: "/routers",        icon: Router,          label: "MikroTik Routers" },
  { path: "/meshdesk",       icon: Radio,           label: "MESHdesk" },
  { path: "/mesh-planner",   icon: Grid3x3,         label: "Mesh Node Planner" },
  { path: "/apdesk",         icon: Wifi,            label: "APdesk" },
  ...
  { path: "/libreqos",       icon: BarChart2,       label: "LibreQoS" },
  ...
  { path: "/proximity-campaigns", icon: MapPin,     label: "Proximity Campaigns" },
  ...
  { path: "/vouchers",       icon: TicketCheck,     label: "Vouchers" },
  ...
  return (
    <aside className="h-full w-full bg-sidebar border-r border-sidebar-border flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-sidebar-border space-y-1 shrink-0">
        <Link to="/hotspot" onClick={onNavClick}
          ...
          <Wifi className="h-3.5 w-3.5 shrink-0" /> <span>Captive Portal</span>
        </Link>
        <Link to="/portal" onClick={onNavClick}
          className="flex items-center gap-3 px-3 py-2 rounded-md text-xs text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">
          <Users className="h-3.5 w-3.5 shrink-0" /> <span>User Portal</span>
        </Link>
