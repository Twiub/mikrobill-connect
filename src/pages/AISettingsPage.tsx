...
import { Brain, Save, RefreshCw, CheckCircle, AlertCircle, Loader2, Zap, Bell, MapPin, MessageSquare, TestTube } from "lucide-react";
        ...
        <div className="glass-card p-5 space-y-4">
          ...
          <div className="flex items-center gap-3">
            <Button variant="outline" size="sm" onClick={handleTest} disabled={testing} className="gap-2">
              {testing ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <TestTube className="h-3.5 w-3.5" />}{testing ? "Testing…" : "Test API Connection"}
            </Button>
