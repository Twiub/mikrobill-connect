      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">AI System Health Monitor</h1>
              <p className="text-sm text-muted-foreground mt-0.5">AI-powered health checks every 5 minutes · GPT-4o analysis</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Badge variant="outline" className={`${overallStyles[report.overall_status]} capitalize`}>
        ...
        <div className="glass-card p-5 border-l-4 border-l-primary">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold mb-2">AI Health Summary</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{report.summary}</p>
              <p className="text-[10px] text-muted-foreground mt-2">Last checked: {new Date(report.timestamp).toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        {/* Health Checks Grid */}
        <div>
          <h3 className="text-sm font-semibold mb-3">Component Health Checks</h3>
